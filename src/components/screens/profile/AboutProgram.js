        ...
        <View style={[styles.background, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.container}>
                ...
                <View style={{ marginTop: 32 }}>
                    ...
                    <Text style={[styles.text, { color: colors.thinText }]}>+7 (777) 777 7777</Text>
                    <Text style={[styles.text, { color: colors.thinText }]}>+7 (777) 777 7777</Text>
                    <Text style={[styles.text, { color: colors.thinText }]}>example@gmail.com</Text>
                    <Text style={[styles.text, { color: 'rgba(10, 49, 255, 1)' }]}>https://example.com</Text>
                </View>
            </View>
